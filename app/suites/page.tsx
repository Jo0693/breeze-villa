...
export default function Suites() {
  ...
  const suites = [
    {
      title: t('suites.suite1.name'),
      description: t('suites.suite1.description'),
      image: 'https://images.unsplash.com/photo-1582719508461-905c673771fd?q=80&w=2940',
      price: t('suites.suite1.price'),
    },
    {
      title: t('suites.suite2.name'),
      description: t('suites.suite2.description'),
      image: 'https://images.unsplash.com/photo-1591088398332-8a7791972843?q=80&w=2940',
      price: t('suites.suite2.price'),
    },
    {
      title: t('suites.suite3.name'),
      description: t('suites.suite3.description'),
      image: 'https://images.unsplash.com/photo-1590490360182-c33d57733427?q=80&w=2940',
      price: t('suites.suite3.price'),
    },
    {
      title: t('suites.suite4.name'),
      description: t('suites.suite4.description'),
      image: 'https://images.unsplash.com/photo-1596394516093-501ba68a0ba6?q=80&w=2940',
      price: t('suites.suite4.price'),
    },
  ];
          ...
          <div className="container mx-auto px-6">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-dark/70 font-body max-w-2xl mx-auto">
                {t('suites.amenitiesSubtitle')}
              </p>
            </div>
            <div className="flex flex-wrap justify-center items-center gap-x-8 gap-y-6">
              <div className="flex items-center space-x-2">
                <Home className="text-gold" size={20} />
                <span className="font-body text-dark">{t('home.suitesCard.title')}</span>
              </div>
              <div className="flex items-center space-x-2">
