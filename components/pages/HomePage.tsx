  ...
  return (
    <>
      ...
      <main>
        ...
        <section data-publisher-section="intro" className="py-20 bg-background">
        ...
        <section data-publisher-section="testimonial" className="py-20 bg-accent">
          <div className="container mx-auto px-6 text-center">
            <SectionTitle title={t('home.testimonialTitle')} />
            <blockquote data-publisher-field="home.testimonialQuote" className="text-xl md:text-2xl font-body italic text-dark/80 max-w-3xl mx-auto">
              &ldquo;{t('home.testimonialQuote')}&rdquo;
            </blockquote>
            <p data-publisher-field="home.testimonialAuthor" className="mt-6 font-body text-dark/60">— {t('home.testimonialAuthor')}</p>
          </div>
        </section>
